...
/**
 * 	\file		core/triggers/interface_99_modMyodule_sarbacanetrigger.class.php
 * 	\ingroup	sarbacane
 * 	\brief		Sample trigger
 * 	\remarks	You can create other triggers by copying this one
 * 				- File name should be either:
 * 					interface_99_modSarbacane_Mytrigger.class.php
 ...
 * Trigger class
 */
class Interfacesarbacanetrigger extends DolibarrTriggers
{
